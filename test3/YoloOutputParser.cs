...
public class YoloOutputParser
{
    ...
    public float[] ExtractClasses(IReadOnlyList<float> modelOutput, int x, int y, int channel)
    {
    ...
    public IList<YoloBoundingBox> ParseOutputs(IReadOnlyList<float> yoloModelOutputs, float threshold = .3F)
    {
